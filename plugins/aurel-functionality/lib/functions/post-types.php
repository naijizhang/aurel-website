...
function version_history() {
	...
	$labels = array(
		'name'                  => _x( 'Versions', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Version', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Version History', 'text_domain' ),
		'name_admin_bar'        => __( 'Version History', 'text_domain' ),
		'archives'              => __( 'Version Archives', 'text_domain' ),
		'attributes'            => __( 'Version Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Version:', 'text_domain' ),
		'all_items'             => __( 'All Versions', 'text_domain' ),
		'add_new_item'          => __( 'Add New Version', 'text_domain' ),
		'add_new'               => __( 'Add New Version', 'text_domain' ),
		'new_item'              => __( 'New Version', 'text_domain' ),
		'edit_item'             => __( 'Edit Version', 'text_domain' ),
		'update_item'           => __( 'Update Version', 'text_domain' ),
		'view_item'             => __( 'View Version', 'text_domain' ),
		'view_items'            => __( 'View Versions', 'text_domain' ),
		'search_items'          => __( 'Search Version', 'text_domain' ),
		'not_found'             => __( 'Not found', 'text_domain' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
		'featured_image'        => __( 'Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
		'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
		'use_featured_image'    => __( 'Use as featured image', 'text_domain' ),
		'insert_into_item'      => __( 'Insert into version', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this version', 'text_domain' ),
		'items_list'            => __( 'Versions list', 'text_domain' ),
		'items_list_navigation' => __( 'Versions list navigation', 'text_domain' ),
		'filter_items_list'     => __( 'Filter versions list', 'text_domain' ),
	);
	$args = array(
		'label'                 => __( 'Version', 'text_domain' ),
		'description'           => __( 'This is the version history of the software.', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
		'hierarchical'          => false,
		'public'                => true,
	...
	register_post_type( 'version_history', $args );

}
add_action( 'init', 'version_history', 0 );