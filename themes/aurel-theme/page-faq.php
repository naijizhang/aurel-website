...
<div id="primary" class="content-area content-all-page content-faq">
	<main id="main" class="site-main" role="main">
		<div class="cadsim-plus-logo"> <img alt="cadsim plus" src='<?php echo get_template_directory_uri() . '/assets/images/CADSIM-Plus_PrimaryLogo.png'; ?>' /></div>
